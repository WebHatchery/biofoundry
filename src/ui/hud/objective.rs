...
fn muster_contract_guidance(session: &GameSession, data: &GameData) -> Option<String> {
    if !session.outpost_relay_claimed
...
fn concord_contract_guidance(session: &GameSession, data: &GameData) -> Option<String> {
...
fn chorus_contract_guidance(session: &GameSession, data: &GameData) -> Option<String> {
