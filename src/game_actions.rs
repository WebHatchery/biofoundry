...
#[path = "game_actions/outpost_upgrades.rs"]
mod outpost_upgrades;
...
impl Game {
    pub(super) fn apply_action(&mut self, action: UiAction) {
        match action {
            ...
            UiAction::UpgradeOutpost(pos) => self.apply_outpost_hold_upgrade(pos),
            UiAction::UpgradeOutpostCrew(pos) => self.apply_outpost_crew_upgrade(pos),
            UiAction::UpgradeOutpostSurvey(pos) => self.apply_outpost_survey_upgrade(pos),
            UiAction::UpgradeOutpostResonator(pos) => self.apply_outpost_resonator_upgrade(pos),
            UiAction::UpgradeOutpostDeepSurvey(pos) => self.apply_outpost_deep_survey_upgrade(pos),
            UiAction::UpgradeOutpostSignalCache(pos) => {
                self.apply_outpost_signal_cache_upgrade(pos)
            }
            UiAction::UpgradeOutpostWaypoint(pos) => self.apply_outpost_waypoint_upgrade(pos),
