...
pub fn job_key(job: Job) -> Option<&'static str> {
    match job {
...
pub fn equip_effect(creature: &Creature, data: &GameData, effect: &str) -> Option<f32> {
...
pub fn wants_gear(creature: &Creature, session: &GameSession, data: &GameData) -> Option<String> {
...
pub fn tick_gear(creature: &mut Creature, session: &mut GameSession, data: &GameData) -> bool {
