...
pub struct Balance {
    ...
    /// Ingot cost for the one-time Outpost camp expansion.
    #[serde(default = "default_outpost_crew_upgrade_ingots")]
    pub outpost_crew_upgrade_ingots: u32,
    ...
    /// Additional scouting hauls required for each repeatable Worm Road
    /// Archive reward after the Charter is claimed.
    #[serde(default = "default_outpost_archive_haul_goal")]
    pub outpost_archive_haul_goal: u32,
    ...
    /// Active Worm routes required for each repeatable post-Convoy Muster.
    #[serde(default = "default_outpost_muster_route_goal")]
    pub outpost_muster_route_goal: u32,
    /// Completed scouting hauls required for each post-Convoy Muster.
    #[serde(default = "default_outpost_muster_haul_goal")]
    pub outpost_muster_haul_goal: u32,
    ...
    /// Complete active Wormsong routes required for the one-time Chorus.
    #[serde(default = "default_outpost_chorus_route_goal")]
    pub outpost_chorus_route_goal: u32,
    /// Ingots awarded when the Wormsong Chorus is completed.
    #[serde(default = "default_outpost_chorus_reward_ingots")]
    pub outpost_chorus_reward_ingots: u32,
    /// Ingots returned by each complete route while the Chorus is intact.
    #[serde(default = "default_outpost_chorus_ingots_per_haul")]
    pub outpost_chorus_ingots_per_haul: u32,
...
fn default_outpost_crew_upgrade_ingots() -> u32 {
    12
}
...
fn default_outpost_archive_haul_goal() -> u32 {
    5
}
...
fn default_outpost_muster_route_goal() -> u32 {
    4
}
fn default_outpost_muster_haul_goal() -> u32 {
    16
}
...
fn default_outpost_chorus_route_goal() -> u32 {
    3
}
fn default_outpost_chorus_reward_ingots() -> u32 {
    80
}
fn default_outpost_chorus_ingots_per_haul() -> u32 {
    1
}
