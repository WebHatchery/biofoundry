...
- `cargo test --all-targets` — 304 unit tests and 2 integration/code-standard
  targets pass,
...
- Current-version save validation — pass; the game shell validates the session
  ...
  payload before it can reach the live Warren.
