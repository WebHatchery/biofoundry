...
- `cargo test --all-targets` — 415 unit tests and 2 integration/code-standard
  targets pass,
...
- Multi-route ledger capture — [ui_endless_routes.png](../verification/ui_endless_routes.png)
  ...
  live Worm Road Charter progress/reward, and attention states before a card is
  opened. A compact 800×450 probe kept the same controls on-canvas without
  overlap.
