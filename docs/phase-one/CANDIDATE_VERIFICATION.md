...
- Settled touch-target audit — pass; `scripts/audit_touch_targets.ps1` walks
  ...
  controls at 30 logical pixels or more; route inspection and optional cards
  still report smaller visual controls, keeping first-time-player readability
  as an honest human follow-up.
