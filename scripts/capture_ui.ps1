...
.DESCRIPTION
    ...
    src/main.rs. Scenes: menu, warren, help, pause, collapse, mine, blacksmith, equipment, overseer, factory, victory, factory_complete, famine, raid, breeding, worm, completion.
...
#>
param(
    [string[]]$Scenes = @("menu", "warren", "help", "pause", "collapse", "mine", "blacksmith", "equipment", "overseer", "factory", "victory", "factory_complete", "famine", "raid", "breeding", "worm", "completion"),
    [int]$Frames = 150,
