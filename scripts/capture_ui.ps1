...
.DESCRIPTION
    ...
    src/main.rs. Scenes: menu, new_warren_confirm, warren, help, pause, collapse, mine, blacksmith, equipment, overseer, factory, tutorial_factory, victory, factory_complete, optional, endless, endless_failure, endless_in_flight, endless_arrived, famine, food_warning, raid_food_warning, raid, raid_warning, breeding, shrine, worm, completion.
