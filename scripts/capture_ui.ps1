...
.DESCRIPTION
    ...
    src/main.rs. Scenes: menu, warren, help, mine, blacksmith, equipment, overseer, factory, famine, raid, breeding, worm, completion.
...
#>
param(
    [string[]]$Scenes = @("menu", "warren", "mine", "blacksmith", "equipment", "overseer", "factory", "famine", "raid", "breeding", "worm", "completion"),
    [int]$Frames = 150,
