...
.DESCRIPTION
    ...
    src/main.rs. Scenes: menu, new_warren_confirm, warren, tutorial_food, tutorial_factory, tutorial_worm, help, pause, collapse, mine, blacksmith, blacksmith_queue_full, equipment, overseer, factory, victory, factory_complete, optional, endless, endless_empty, endless_failure, endless_in_flight, endless_arrived, famine, food_warning, raid_food_warning, raid, raid_warning, breeding, shrine, worm, completion.
