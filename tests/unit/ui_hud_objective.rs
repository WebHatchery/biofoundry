...
use biofoundry::state::outposts::{Outpost, TransitDirection, WormTransit};
use biofoundry::state::structures::{BuildSite, Building};
use biofoundry::state::GameSession;
use biofoundry::ui::hud::objective::*;

#[path = "ui_hud_objective/charter.rs"]
mod charter;
#[path = "ui_hud_objective/chorus.rs"]
mod chorus;
#[path = "ui_hud_objective/outposts.rs"]
mod outposts;
#[path = "ui_hud_objective/route_upgrades.rs"]
mod route_upgrades;
